  ...
  return (
    <>
      <nav
        ...
        } bg-white/90 backdrop-blur-md border-b border-[#E2E8F0] h-[70px] lg:h-20 flex items-center ${
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 h-full">
          <div className="flex items-center justify-between h-full w-full">
              ...
              <Link to="/" className="flex items-center space-x-2.5 group z-20">
                ...
                <div className="flex flex-col">
                  <span className="text-lg lg:text-xl font-bold tracking-tight leading-none font-poppins">
                    ...
                    <span className="text-[#2563EB] ml-1">Acceleration</span>
                  </span>
                  <span className="text-[10px] text-gray-500 font-medium tracking-normal mt-1 leading-none transition-colors group-hover:text-gray-800">
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              <Link
                to="/signup"
                className="px-5 py-2 text-sm font-semibold border border-[#2563EB] text-[#2563EB] bg-white rounded-full hover:bg-blue-50 active:scale-95 transition-all duration-200"
              >
                Sign Up
              </Link>
              ...
              <Link
                to="/games"
                className="px-5 py-2.5 text-sm font-semibold text-white bg-[#2563EB] rounded-full shadow-[0_4px_12px_rgba(37,99,235,0.15)] hover:shadow-[0_6px_20px_rgba(37,99,235,0.3)] transform hover:scale-105 active:scale-95 transition-all duration-200"
              >
                Start Training
              </Link>
            </div>
            ...
            <div className="lg:hidden flex items-center z-20">
              <button
                ...
                className="text-[#334155] hover:text-[#2563EB] focus:outline-none transition-colors p-2"
      ...
      <div
        className={`fixed top-0 right-0 bottom-0 w-[300px] max-w-full bg-white/95 backdrop-blur-md shadow-2xl border-l border-slate-100 z-50 p-6 flex flex-col transition-transform duration-300 ease-out transform lg:hidden ${
      ...
      >
        ...
        <div className="flex items-center justify-between pb-6 border-b border-slate-100">
          ...
          <button
            onClick={() => setIsOpen(false)}
            className="text-slate-500 hover:text-[#2563EB] p-1.5 rounded-lg hover:bg-slate-100 transition-colors"
        ...
        <div className="pt-6 border-t border-slate-100 flex flex-col space-y-3">
          ...
          <Link
            to="/signup"
            onClick={() => setIsOpen(false)}
            className="w-full py-2.5 text-center text-sm font-semibold border border-[#2563EB] text-[#2563EB] rounded-full hover:bg-blue-50 transition-colors"
          >
            Sign Up
          </Link>
          ...
          <Link
            to="/games"
            onClick={() => setIsOpen(false)}
            className="w-full py-3 text-center text-sm font-semibold text-white bg-[#2563EB] rounded-full shadow-[0_4px_12px_rgba(37,99,235,0.15)] hover:bg-blue-700 transition-colors"
          >
            Start Training
          </Link>
        </div>
