...
const NumberMemory = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-[100px])] py-8 bg-[#e8f9fd] px-4 font-sans text-gray-900">
      ...
      <div className="w-full max-w-4xl bg-gradient-to-br from-pink-400 to-rose-600 rounded-2xl md:p-6 p-4 shadow-2xl shadow-pink-900/40 flex flex-col items-center justify-center relative overflow-hidden backdrop-blur-md border border-white/20 pb-10 min-h-[500px]">
        ...
        <div className="w-full flex justify-between absolute top-4 left-0 px-6">
            ...
            <div className="flex space-x-3 text-xl text-pink-100 mt-2 md:mt-0">
        ...
        {gameState === 'showing' && (
            <div className="w-full max-w-md h-3 bg-black/20 rounded-full overflow-hidden mt-8 border border-white/10 shadow-inner">
                <div 
                    className="h-full bg-white transition-all duration-75 ease-linear rounded-full shadow-[0_0_10px_rgba(255,255,255,0.8)]"
        ...
        {gameState === 'input' && (
            <div className="flex flex-col items-center w-full max-w-sm mt-4">
                <input 
                    ...
                    className="w-full bg-black/20 border-b-4 border-white/50 focus:border-white text-center text-4xl text-white font-mono py-4 outline-none transition-colors mb-8 shadow-inner"
                    autoFocus
                    autoComplete="off"
                />
                ...
                <div className="grid grid-cols-3 gap-3 w-full mb-6">
                    ...
                    <button 
                        ...
                        className={`font-bold text-xl py-4 rounded-xl border border-white/20 backdrop-blur-sm transition-all active:scale-95 ${userAnswer.length > 0 ? 'bg-white text-pink-700 hover:bg-pink-100 shadow-[0_0_15px_rgba(255,255,255,0.5)]' : 'bg-white/30 text-white/50 cursor-not-allowed'}`}
                    >
                        OK
                    </button>
                </div>
        ...
        {gameState === 'transition' && (
             <div className="mt-8 px-12 py-4 bg-white text-pink-600 rounded-full text-2xl font-black shadow-[0_0_30px_rgba(255,255,255,0.8)] animate-bounce">
                CORRECT
             </div>
        )}
